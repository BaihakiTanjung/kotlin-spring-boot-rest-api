package io.github.baihakitanjung.playersapi.controller

import io.github.baihakitanjung.playersapi.model.Player
import io.github.baihakitanjung.playersapi.service.PlayerService
...
class PlayerController(val service: PlayerService) {
    ...
    @GetMapping fun getAllPlayers() = service.getAll()

    @GetMapping("/{id}") fun getPlayer(@PathVariable id: Long) = service.getById(id)
